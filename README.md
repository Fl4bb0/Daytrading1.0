...
Walk-forward comparison outputs are written to:

prepared/walkforward/comparisons/latest/

They include `run_comparison_summary.csv`, `fold_comparison.csv`, and
comparison plots for net return, accuracy, stability, and fold distributions.
